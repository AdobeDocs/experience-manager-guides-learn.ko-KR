...
* **Markdown 문서 지원**
Markdown은 일반 텍스트 문서에 서식 요소를 추가하는 데 도움이 되는 간단한 마크업 언어입니다. 웹 편집기를 사용하면 DITA 문서와 함께 Markdown 문서(.md)를 사용할 수 있습니다. 웹 편집기에서 Markdown 문서를 쉽게 작성하고 미리 볼 수 있으며 DITA 맵 편집기를 통해 맵 파일에 추가할 수도 있습니다.  자세한 내용은 
*웹 편집기에서 Markdown 문서 작성* 섹션: Adobe Experience Manager 안내서 사용.
...
* FrameMaker/Oxygen 커넥터에서 여러 파일을 업로드할 때 잘못된 UUID 참조가 할당되었습니다. (8269)
