...
description: Adobe Experience Manager 안내서 11월 릴리스 as a Cloud Service
...
# Adobe Experience Manager 안내서 11월 릴리스 as a Cloud Service
...
1. 업데이트 `<dox.version>` 속성 `/dox/dox.installer/pom.xml` Cloud Services Git 코드 파일에 2022.11.198.
...
AEM 안내서에서는 11월 릴리스의 향상된 기능과 새로운 기능을 as a Cloud Service으로 제공합니다.
