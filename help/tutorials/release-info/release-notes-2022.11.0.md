...
* 기본 PDF | 표 머리글에서 각주를 사용하면 PDF 출력 내의 바닥글에 굵게 맞춤되고 가운데 맞춤된 각주 텍스트가 표시됩니다. (10610)
...
* 기준 게시 사용 시 잘못된 게시 `cq:tags` 을 선택합니다(버전 복사 대신 현재 작업 복사본에서 선택됨). (10494)
...
* 웹 편집기에서 작성하는 동안 첫 번째 문자가 한국어 언어로 끊어집니다. (10049)
