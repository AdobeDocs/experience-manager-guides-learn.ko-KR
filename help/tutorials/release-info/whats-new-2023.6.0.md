...
AEM Guides를 사용하면 기술 문서의 전체 완성도를 확인하고 웹 편집기에서 보고서를 생성할 수 있습니다. 이제 2023년 6월 릴리스 AEM Guides에서는 끊어진 링크를 보고 수정하는 기능을 제공합니다. 끊어진 링크를 관리하는 데 도움이 되는 매우 유용한 보고서입니다. DITA 맵에 있는 끊어진 링크를 쉽게 보고 수정할 수도 있습니다.
...
이제 저장소 패널에서 파일 이름을 바꾸거나 파일을 이동할 수도 있습니다. 이 기능은 매우 편리하고 저장소 패널에서 파일을 쉽게 관리하는 데 도움이 됩니다. 파일을 선택하고 이름을 변경하거나 **옵션** 선택한 파일에 대한 메뉴 파일을 이동하거나 이름을 변경하면 AEM Guides에 성공 메시지가 표시됩니다.
...
문서의 마스터 페이지에서 실행 중인 머리글 또는 바닥글에 언어 변수를 추가할 수 있습니다. 변수는 이 마스터 페이지가 적용된 문서의 모든 본문 페이지에 표시됩니다. 예를 들어 1페이지 중 1페이지입니다.
다양한 언어로 숫자를 나타내는 데 사용할 수도 있습니다.
