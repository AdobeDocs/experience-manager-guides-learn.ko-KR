...
버전 4.3.0으로 업그레이드하는 방법은 현재 버전의 AEM Guides에 따라 다릅니다. 버전 4.2 또는 4.2.x를 사용 중인 경우 버전 4.3.0으로 바로 업그레이드할 수 있습니다.
...
AEM Guides 4.3.0 업그레이드 프로세스를 시작하기 전에 다음을 확인하십시오.

1. AEM Guides 버전 4.2 또는 4.2.x로 업그레이드하고 해당 설치 단계를 완료했습니다.
1. 모든 번역 작업을 마감했습니다.
