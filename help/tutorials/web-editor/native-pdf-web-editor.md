...
| **게시된 버전 간 변경 막대를 사용하여 PDF 만들기** | 다음 옵션을 사용하여 변경 막대를 사용하여 두 버전 간의 컨텐츠의 차이점을 보여주는 PDF을 만듭니다.   <br>* **이전 버전의 기준선** 현재 버전이나 다른 베이스라인과 비교할 베이스라인 버전을 선택합니다. PDF에 수정된 컨텐츠를 나타내는 변경 표시줄이 나타납니다. 변경 표시줄은 새 컨텐츠나 수정된 컨텐츠를 시각적으로 식별하는 세로 줄입니다. 변경 표시줄은 삽입, 변경 또는 삭제된 컨텐츠의 왼쪽에 나타납니다. <br> **참고**: 선택하는 경우 **기준선 사용** 게시할 기준선을 선택하고 선택한 두 베이스라인 버전 간에 비교가 수행됩니다. 예를 들어, 아래에서 기준 요소 버전 1.3을 선택하면 **기준선 사용**&#x200B;및 버전 1.1 아래의 **이전 버전의 기준선**&#x200B;을 눌러 기준 요소 버전 1.1과 기준 요소 버전 1.3 간에 비교가 수행됩니다. <br>* **추가된 텍스트 표시** 삽입된 텍스트를 녹색 색상과 밑줄이 그어진 모양으로 표시하려면 선택합니다. 이 옵션은 기본적으로 선택되어 있습니다. <br> * **삭제된 텍스트 표시** 삭제된 텍스트를 빨간색으로 표시하고 취소선을 표시하려면 선택합니다. 이 옵션은 기본적으로 선택되어 있습니다. <br>**참고** 스타일시트를 사용하여 변경 막대, 삽입된 컨텐츠 또는 삭제된 컨텐츠의 스타일링을 사용자 정의할 수도 있습니다.<br> |
