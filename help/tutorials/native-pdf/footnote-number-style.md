...
특정 특성이 있는 각주 호출에 스타일을 적용할 수도 있습니다. 예를 들어 ID가 있는 각주를 숨기려면 다음 스타일을 사용합니다. 각주 호출은 기본 컨텐츠에서 숨겨지지만 각주 마커는 페이지 하단에 나타납니다.
...
방법 알아보기 [페이지 레이아웃의 페이지 속성을 사용하여 작업](./design-page-layout.md#page-props-page-layout).
...
페이지 레이아웃에서 숫자를 지정하여 PDF 문서의 여러 섹션에서 각주 번호 매기기를 다시 시작할 수 있습니다. 예를 들어, **번호 매기기 재시작 위치** 각 챕터의 각주 번호 매기기를 다시 시작하려면 페이지 속성 패널의 필드입니다.
