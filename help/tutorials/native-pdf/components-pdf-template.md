...
* 인용
  ...
  <img src="assets/page-order-advance-settings.png" alt="페이지 순서" width="550">

  PDF 출력에 특정 섹션을 표시하지 않으려면 전환 스위치를 끄면 이를 숨길 수 있습니다.

  PDF에서 생성되는 이러한 서로 다른 섹션의 순서를 정의할 수도 있습니다. 이러한 섹션의 기본 순서를 변경하려면 점선 막대를 선택하여 원하는 위치에 섹션을 드래그 앤 드롭합니다.
