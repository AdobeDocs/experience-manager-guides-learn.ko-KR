...
1. **템플릿** 패널에서 **템플릿** 옆에 있는 **+** 아이콘을 선택하고 **PDF 템플릿**을 선택합니다.
...
1. 왼쪽 사이드바를 확장하고 을 선택합니다. **템플릿**.
   ...
   템플릿 패널이 열립니다.
1. 복제할 템플릿 위로 마우스를 가져간 다음 (*옵션* 아이콘) **...** 및 선택 **복제** 컨텍스트 메뉴 아래의 제품에서 사용할 수 있습니다.
...
1. 템플릿의 구성 요소를 보려면 다음 중 하나를 수행하십시오.
   ...
   * 템플릿 위로 마우스를 가져간 후 ... (옵션 아이콘)을 선택하고 컨텍스트 메뉴에서 편집을 선택합니다.
