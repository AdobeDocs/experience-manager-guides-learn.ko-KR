...
AEM 가이드는 PDF, HTML5 및 EPUB 형식으로 FrameMaker 문서에 대한 출력 만들기를 지원합니다. 이러한 출력 형식을 사용하여 다양한 출력 사전 설정을 구성할 수 있습니다. 출력 사전 설정은 컨텐츠를 게시하려는 사용자 지정된 출력 형식을 나타냅니다.
