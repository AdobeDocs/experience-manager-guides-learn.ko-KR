---
title: 기준선으로 작업
description: 기준선으로 작업하는 방법 알아보기
...
1. 다음을 클릭합니다. **모든 항목 찾아보기** DITA 맵에서 참조된 모든 주제 및 미디어 파일을 로드하는 링크입니다. 주제 및 미디어 파일의 UUID는 주제 제목 또는 \(media\) 파일 이름 아래에도 표시됩니다.
   ...
   레이블을 사용하여 기준선을 만드는 경우 **자동으로 선택** 참조된 모든 콘텐츠의 버전에 적용됩니다.
...
1. 다음에서 **레이블 추가** 대화 상자에서 이 기준선과 연결할 고유한 레이블을 지정합니다.
