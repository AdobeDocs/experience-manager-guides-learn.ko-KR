---
title: 웹 편집기에서 문서 번역
description: 웹 편집기에서 문서를 번역하는 방법을 알아봅니다.
...
1. 번역을 위해 전송할 주제를 선택합니다.
   ...
   - **Target 언어**: 소스 파일을 번역할 언어
   - **번역 상태**: 사용할 수 있는 옵션은 [동기화 중단], [복사본 누락], [진행 중] 및 [동기화 중]입니다.
   - **Target 레이블**: 선택한 대상 파일 버전에 대한 레이블
...
1. 드롭다운에서 을 선택합니다. **새 번역 프로젝트 만들기**.
   ...
   - 다음을 선택할 수 있습니다. **새 XLIFF 번역 프로젝트 만들기** 를 클릭하여 XML 내용을 XML 로컬라이제이션 교환 파일 형식(XLIFF)으로 변환합니다. XLIFF는 컨텐츠 번역 프로세스에서 사용되는 다양한 도구 간의 데이터 전송을 표준화하는 데 사용되는 개방형 XML 기반 형식입니다.
...
1. 클릭 **강제 동기화**. 선택한 동기화되지 않은 에셋에 대해 [동기화 중]으로 상태를 설정합니다.
