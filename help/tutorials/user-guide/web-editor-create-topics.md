...
AEM Guides를 사용하면 주제, 작업, 개념, 참조, 용어집, DITAVAL 등의 유형의 DITA 주제를 만들 수 있습니다. 기본 제공 템플릿을 기반으로 주제를 만드는 것 외에도 사용자 지정 템플릿을 정의할 수도 있습니다. 사용자 지정 DITA 템플릿 사용에 대한 자세한 내용은 *작성을 위한 템플릿 및 태그 구성* 에서 Adobe Experience Manager Guides as a Cloud Service 설치 및 구성.
...
1. 블루프린트 페이지에서 만들려는 DITA 문서의 유형을 선택하고 을 클릭합니다 **다음**.
   ...
   기본적으로 AEM Guides는 가장 일반적으로 사용되는 DITA 주제 템플릿을 제공합니다. 조직 요구 사항에 따라 더 많은 주제 템플릿을 구성할 수 있습니다. 다음을 참조하십시오. *작성을 위한 템플릿 및 태그 구성* 에서 Adobe Experience Manager Guides as a Cloud Service 설치 및 구성.
