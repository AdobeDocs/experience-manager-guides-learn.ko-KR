...
description: DITA 콘텐츠의 벌크 태그 지정 방법 알아보기
...
AEM Guides를 사용하면 몇 번의 클릭만으로 DITA 콘텐츠에 태그를 지정할 수 있습니다. 벌크 태그 지정 기능을 사용하여 여러 주제, DITA 맵 또는 하위 맵에 여러 태그를 적용할 수 있습니다. 또는 개별 주제에 태그를 적용할 수도 있습니다. 태깅은 AEM의 기본 기능으로,에서 태그 만들기 및 관리에 대한 자세한 내용을 찾을 수 있습니다. [태그 관리](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/tags.html?lang=en) AEM 섹션 을 참조하십시오.

기본적으로 AEM Guides는 AEM 저장소의 모든 태그가 저장된 폴더에 있는 사용자에게 읽기 액세스 권한을 부여하지 않습니다. AEM 저장소에 정의된 태그를 사용하려면 시스템 관리자에게 태그가 저장된 폴더에 대한 액세스 권한을 부여하도록 요청해야 합니다.
...
1. 도구 모음에서 를 클릭합니다 **속성**.

   주제의 등록 정보 페이지가 나타납니다.

1. 기본 탭에서 다음 옆에 있는 찾아보기 아이콘을 클릭합니다. **태그** 필드.
...
1. 삭제 확인 대화 상자에서 **확인** 을 눌러 선택한 항목에서 태그를 제거합니다.
