...
DITA 콘텐츠 키 참조 또는 `conkeyref` 는 한 주제의 내용 일부를 다른 주제에 삽입하는 메커니즘입니다. 이 메커니즘은 키를 사용하여 직접 콘텐츠 참조 메커니즘이 아닌 재사용할 콘텐츠를 찾습니다. DITA의 직접 및 간접 참조에 대한 자세한 내용은 *DITA 주소 지정* (OASIS DITA 언어 사양)에서 참조할 수 있습니다.
...
**주제 편집 보기** - DITA 주제를 편집하는 동안 키 확인 아이콘을 클릭하고 키 참조를 확인하는 데 사용할 DITA 파일을 선택합니다.
