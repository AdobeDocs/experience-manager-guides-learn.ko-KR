...
1. 양방향 화살표가 나타나면 필요에 따라 내측 또는 외측으로 클릭하여 드래그합니다.
...
1. 을(를) 클릭합니다. [!UICONTROL **사이드바**] 아이콘을 다시 클릭하여 패널을 축소합니다.
...
1. 을(를) 클릭합니다. [!UICONTROL **플러스**] 아이콘.

   ![즐겨찾기 플러스](images/lesson-5/favorites-plus.png)

1. 새 컬렉션 대화 상자에서 **제목** 그리고 **설명**.
...
1. 을(를) 클릭합니다. [!UICONTROL **줄임표**] 주제 옆에 위치하며 컨텍스트 옵션에 액세스합니다.
...
1. 파일의 **제목 탭** 편집기에서 상황별 옵션에 액세스합니다.
...
1. 즐겨찾기에서 [!UICONTROL **화살표**] 컬렉션 옆에 있는 아이콘을 클릭하여 해당 콘텐츠를 확인합니다.

   ![즐겨찾기 보기](images/lesson-5/view-favorites.png)

1. 을(를) 클릭합니다. [!UICONTROL **줄임표**] 주제 옆에 있는 즐겨찾기 목록에서 컨텍스트 옵션을 삭제하는 옵션을 포함하여 상황별 옵션을 표시합니다.
...
1. 을(를) 클릭합니다. [!UICONTROL **검색 필터링**] 아이콘.

   ![저장소 필터 아이콘](images/lesson-5/repository-filter-icon.png)

1. 선택한 경로에 텍스트를 입력하거나 필요한 경우 새 경로를 선택합니다.
...
1. 요소 내에서 보조 마우스 단추를 클릭합니다.

1. 결과 메뉴에서 만들기를 선택합니다 [!UICONTROL **코드 조각**].

   ![코드 조각 만들기](images/lesson-5/create-snippet.png)

1. 새 코드 조각 대화 상자에서 **제목** 그리고 **설명**.
...
1. 을(를) 클릭합니다. [!UICONTROL  **파일 속성**] 아이콘을 클릭합니다.

   ![파일 속성 아이콘](images/lesson-5/file-properties-icon.png)

1. 설정 **문서 상태** to **편집**. 참조(References) 목록은 현재 비어 있습니다.

   ![참조 없음](images/lesson-5/no-references.png)

1. 항목을 닫습니다.

1. 선택 [!UICONTROL **저장소 보기**] 왼쪽 패널에 표시됩니다.

1. 맵을 엽니다.

   보기가 맵 보기에 변경됩니다.

1. 을(를) 클릭합니다. [!UICONTROL **편집**] 아이콘.

   ![맵 편집 아이콘](images/lesson-5/edit-map-icon.png)

1. 맵을 열어 편집하고 나면 다시 로 전환합니다. **저장소 보기**.

1. 작업 중인 항목을 드래그하여 맵에 놓습니다.

1. 을(를) 클릭합니다. [!UICONTROL **저장**] 아이콘 사용 안 함
