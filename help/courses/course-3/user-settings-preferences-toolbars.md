...
1. 을(를) 클릭합니다. [!UICONTROL **태그 보기 전환**] 아이콘을 클릭합니다.
   ...
   ・ 컨텍스트 메뉴를 사용하여 선택한 요소를 잘라내거나 복사하거나 지나갑니다.

   ・ 태그를 선택하고 요소를 유효한 위치에 드래그하여 놓습니다.

2. 을(를) 클릭합니다. [!UICONTROL **태그 보기 전환**] 아이콘을 다시 클릭하여 태그를 숨깁니다.
...
2. 을(를) 클릭합니다. [!UICONTROL **잠금 해제**] 아이콘.
...
2. 특수 문자 삽입 대화 상자에서 검색 창에 문자 이름을 입력합니다.
...
2. 사용자 환경 설정 대화 상자에서 [!UICONTROL **테마**] 드롭다운.

3. 사용 가능한 옵션 중에서 선택합니다.
...
2. 사용자 환경 설정 대화 상자에서 [!UICONTROL **폴더**] 기본 경로 옆에 있는 아이콘을 클릭합니다.

   ![기본 폴더 경로](images/lesson-2/base-path-folder-icon.png)

3. 경로 선택 대화 상자에서 특정 폴더 옆에 있는 확인란을 클릭합니다.
...
2. 사용자 환경 설정 대화 상자에서 [!UICONTROL **폴더 프로필**] 드롭다운.

   ![프로필 목록](images/lesson-2/folder-profiles-dropdown.png)

3. 사용 가능한 옵션에서 프로필을 선택합니다.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **일반**] 탭.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **패널**] 탭.

3. 사용 가능한 패널을 필요에 따라 표시 또는 숨기기로 전환합니다.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **요소 목록**] 탭.

3. 을(를) 입력합니다 **요소 이름** 그리고 **레이블** 를 입력합니다.

4. 을(를) 클릭합니다. [!UICONTROL **플러스**] 아이콘을 클릭하여 목록에 요소를 더 추가합니다.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **속성 목록**] 탭.

3. 을(를) 입력합니다 **속성 이름** 그리고 **레이블** 를 입력합니다.

4. 을(를) 클릭합니다. [!UICONTROL **플러스**] 아이콘을 클릭하여 목록에 속성을 더 추가합니다.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **조건**] 탭.

3. 적용할 조건의 확인란을 선택합니다.
...
2. 편집기 설정 대화 상자에서 [!UICONTROL **프로필**] 탭.

3. 을(를) 클릭합니다. [!UICONTROL **플러스**] 프로필 옆에 있는 아이콘을 클릭합니다.
