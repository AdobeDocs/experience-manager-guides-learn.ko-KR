...
1. 다음을 클릭합니다. [!UICONTROL **태그 보기 전환**] 아이콘을 클릭합니다.
...
1. 다음을 클릭합니다. [!UICONTROL **태그 보기 전환**] 아이콘을 다시 클릭하여 태그를 숨깁니다.
...
1. 다음을 클릭합니다. [!UICONTROL **잠금**] 아이콘을 클릭합니다.

   ![체크아웃](images/lesson-2/checkout-icon.png)

   파일이 체크 아웃되고 저장소의 파일 이름 옆에 잠금 아이콘이 나타납니다.

1. 다음을 클릭합니다. [!UICONTROL **잠금 해제**] 아이콘.
...
1. 다음을 클릭합니다. [!UICONTROL **특수 문자 삽입**] 아이콘을 클릭합니다.

   ![특별 광고](images/lesson-2/special-icon.png)
...
## 작성자, 소스 및 미리보기 모드 간 전환

화면 오른쪽 상단의 도구 모음을 사용하여 보기 간에 전환할 수 있습니다.

![모드](images/lesson-2/modes.png)

- 선택 **작성자** 을 클릭하여 항목으로 작업할 때 구조와 콘텐츠를 볼 수 있습니다.

- 선택 **소스** 을 클릭하여 항목을 구성하는 기본 XML을 표시합니다.

- 선택 **미리 보기** 을 클릭하여 사용자가 브라우저에서 항목을 볼 때 표시되는 방식을 보여 줍니다.
...
1. 사용자 환경 설정 대화 상자에서 [!UICONTROL **테마**] 드롭다운입니다.
...
1. 사용자 환경 설정 대화 상자에서 [!UICONTROL **폴더**] 기본 경로 옆에 있는 아이콘

   ![기본 폴더 경로](images/lesson-2/base-path-folder-icon.png)

1. 경로 선택 대화 상자에서 특정 폴더 옆의 확인란을 클릭합니다.
...
1. 사용자 환경 설정 대화 상자에서 [!UICONTROL **폴더 프로필**] 드롭다운입니다.
...
1. 다음을 클릭합니다. [!UICONTROL **편집기 설정**] 아이콘을 클릭합니다.
...
1. 입력 **요소 이름** 및 a **레이블** 을 참조하십시오.

1. 다음을 클릭합니다. [!UICONTROL **플러스**] 목록에 요소를 더 추가하는 아이콘.
...
1. 입력 **속성 이름** 및 a **레이블** 을 참조하십시오.

1. 다음을 클릭합니다. [!UICONTROL **플러스**] 아이콘을 클릭하여 목록에 속성을 더 추가합니다.
...
1. 다음을 클릭합니다. [!UICONTROL **플러스**] 아이콘 을 클릭하여 제품에서 사용할 수 있습니다.
