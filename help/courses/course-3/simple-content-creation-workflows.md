...
AEM Guides 편집기에는 콘텐츠 작성 워크플로를 간소화하는 여러 단축키가 있습니다. 이러한 단축키를 사용하면 이미지를 빠르게 추가 및 수정하고, 한 번에 여러 주제로 작업하고, 오류를 수정하고, 주제 PDF를 다운로드하고, 버전 및 레이블을 사용할 수 있습니다.
...
1. 필요한 경우 **변환 이름** 또는 **DITA-OT 명령줄 인수**&#x200B;에 대한 정보를 입력하십시오. 모든 필드가 비어 있는 경우 PDF이 계속 생성됩니다.
