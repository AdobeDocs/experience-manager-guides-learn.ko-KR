...
AEM Guides Editor에는 콘텐츠 작성 워크플로를 간소화하는 여러 단축키가 있습니다. 이러한 단축키를 사용하면 이미지를 빠르게 추가 및 수정하고, 한 번에 여러 주제로 작업하고, 오류를 수정하고, 주제 PDF을 다운로드하고, 버전 및 레이블을 사용할 수 있습니다.
...
1. 이미지를 토픽에 바로 드래그하여 놓습니다. 다음 **자산 업로드** 대화 상자가 나타납니다.
...
1. 다음을 클릭합니다. [!UICONTROL **PDF 아이콘**] 주제 위에 있습니다. 대화 상자가 나타납니다.

   ![PDF 내보내기](images/lesson-15/pdf-export.png)

1. 다음 중 하나에 대한 정보를 입력하십시오. **변형 이름** 또는 **DITA-OT 명령줄 인수** 필요한 경우. 모든 필드가 비어 있는 경우에도 PDF이 생성됩니다.
...
1. 다음을 클릭합니다. **저장소** 왼쪽 상단 메뉴의 아이콘을 클릭합니다.
...
버전 번호만 기반으로 주제의 상태를 추적하기가 어려울 수 있습니다. 레이블을 사용하면 여러 수정 버전이 있는 주제의 정확한 상태를 보다 쉽게 식별할 수 있습니다.
...
1. 다음을 클릭합니다. [!UICONTROL **사용자 환경 설정**] 아이콘: 현재 항목의 왼쪽 상단
...
1. 선택 [!UICONTROL **에셋 UI에서 보기**].

   ![에셋 UI](images/lesson-15/view-assets-ui.png)

   - 레이블이 있는 버전 내역은 왼쪽에 표시됩니다.

   ![버전 내역](images/lesson-15/version-history.png)

1. 다음 옵션에 액세스하려면 버전을 클릭하십시오. **이 버전으로 되돌리기** 및 **버전 미리 보기**.

## 새 템플릿 만들기

템플릿은 주제와 맵 모두에 존재합니다. 관리자는 왼쪽 패널에서 템플릿에 액세스할 수 있습니다.

1. 클릭 [!UICONTROL **템플릿**] 왼쪽 패널에서
