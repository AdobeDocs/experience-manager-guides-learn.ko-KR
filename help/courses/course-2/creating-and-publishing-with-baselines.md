...
1. 필요한 경우 기준선에 새 이름을 지정합니다.

1. &quot;버전 기준 설정&quot; 제목 아래에서 레이블 원을 선택합니다.
...
1. 버전 기준 설정 제목 아래에서 &quot;버전 기준&quot;에 대한 원을 선택합니다.

   ![version-on.png](images/version-on.png)

1. 달력 아이콘을 선택하고 원하는 날짜 및 시간을 지정합니다.
...
1. 수정할 항목의 경우 버전 열 아래의 드롭다운에서 원하는 버전을 선택합니다.
...
1. 기준 요소 사용 확인란을 선택하고 드롭다운 메뉴에서 원하는 기준 요소를 선택합니다.
